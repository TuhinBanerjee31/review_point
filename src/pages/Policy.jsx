    ...
    <div className="bg-[#E9F1FA] font-Quicksand">
      ...
      <div className="min-h-screen pt-6 pb-10">
        ...
        <h5 className="text-lg tracking-wider max-w-screen-xl mx-auto">
          At OnSiteBestReview, one of our main priorities is the privacy of our
          visitors. This Privacy Policy document contains types of information
          that is collected and recorded by OnSiteBestReview and how we use it.
        ...
        <h5 className="text-lg tracking-wider max-w-screen-xl mx-auto">
          OnSiteBestReview follows a standard procedure of using log files.
        ...
        <h5 className="text-lg tracking-wider max-w-screen-xl mx-auto">
          Like any other website, OnSiteBestReview uses ‘cookies’. These cookies
        ...
        <h5 className="text-lg tracking-wider max-w-screen-xl mx-auto">
          OnSiteBestReview Privacy Policy does not apply to other advertisers or
        ...
        <h5 className="text-lg tracking-wider max-w-screen-xl mx-auto">
          ...
          OnSiteBestReview does not knowingly collect any Personal Identifiable
        ...
        <h5 className="text-lg tracking-wider max-w-screen-xl mx-auto">
          ...
          shared and/or collect in OnSiteBestReview. This policy is not
